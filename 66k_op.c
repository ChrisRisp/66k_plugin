...
//
// Instruction Ops/Decoder //
// 
// Credit to Andy Sloane & Doc
// 
// TODO Add types for Calls
// TODO Complete types for Jmps
// TODO Add types for logical ops
// TODO Add types for stack ops
//
//
...
int dasmfunc_c9(dasm_state *D, char *buf) {
	...
	if(1) {
		...
		D->op->type = R_ANAL_OP_TYPE_JMP;
		D->op->jump = (ut64) D->pc+op[1]+2;
		D->op->fail = D->pc+2;
